...
<html lang="en">
    ...
    <body>
        ...
        <a href="../booking/previous_bookings.php">
    ...
    <center><form class="form-validation" id="dor_payment_form">
            ...
            <center><h7 class="font-weight-light">Date : <?Php echo $x; ?></h7></center>
    ...
    <center><form  action="payment_confirmation.php" style="text-align: center" method="post">

...
<html lang="en">
    ...
    <a href="bookings.php"></a>
        ...
        <br>
        <br>
    <center><h1 class="font-weight-light" ><span style="color: #E56565">Current Bookings</span></h1></center>
    <section>
    <center><img src="../img/admin.png" width="150" alt=""/></center>
